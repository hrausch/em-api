...
<form class="form-horizontal" id="formDemanda" method="POST" action="{url}index.php/Historicodealuno/gerarInfo" enctype="multipart/form-data">
...
if ($ad != NULL) {
  echo $ad;
    ...
    echo '<h3> Não há nada para ser listado';
}
if ($sg != NULL) {
  echo $sg;
} else {
