...
<html>
    ...
    <head>
        ...
        <!-- Icon -->
        <title>Login - Sistemas do Professor</title>
        <!-- Icon -->
    ...
    <body id="html">
            ...
            <div id="loginbox" class="mainbox col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
                ...
                <div class="panel panel-default"  >
                    <div class="panel-heading" >
                        <div class="panel-title text-center">Sistema do Professor</div>
                    </div>

                    <div class="panel-body" >

                        <form name="form" id="form" action="{url}index.php/Login/fazerLogin"  class="form-horizontal" enctype="multipart/form-data" method="POST">

                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                <input id="login" type="text" class="form-control" name="login" placeholder="Usuário">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12 controls">
                                    <center>
                                        <button style="background: #17578c" type="submit" class="btn btn-primary"><i class="fa fa-sign-in"></i> Entrar</button>
                                    </center>
                                </div>
                            </div>
                ...
                <div class="panel panel-default" >
                    <div class="panel-heading">
                        <div class="panel-title text-center">Pedido de Segunda Chamada</div>
                    </div>

                    <div class="panel-body" >
                      <span class="pull-left">Faça seu pedido de segunda chamada</span><br>
                      <a><span class="pull-right"><i><a  href="{url}index.php/usercomum/Segundachamada" style=" color:#0c59e9">Clique Aqui...</a></i></span></a>
        ...
        <div id="particles"></div><br><br><br><br><br><br>
